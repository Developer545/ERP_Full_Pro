...
export const MENU_ITEMS: MenuItemConfig[] = [
  ...
  },
  {
    ...
    children: [
      { key: "/contabilidad/periodos", label: "Períodos Contables", icon: "CalendarOutlined" },
      { key: "/contabilidad/cuentas", label: "Catálogo de Cuentas", icon: "OrderedListOutlined" },
      { key: "/contabilidad/asientos", label: "Asientos", icon: "EditOutlined" },
      { key: "/contabilidad/libros", label: "Libro Diario", icon: "BookOutlined" },
      { key: "/contabilidad/libro-mayor", label: "Libro Mayor", icon: "FileSearchOutlined" },
      { key: "/contabilidad/balance-comprobacion", label: "Balance Comprobación", icon: "CheckSquareOutlined" },
